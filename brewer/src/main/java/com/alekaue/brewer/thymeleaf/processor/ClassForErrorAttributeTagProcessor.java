package com.alekaue.brewer.thymeleaf.processor;
...
public class ClassForErrorAttributeTagProcessor extends AbstractAttributeTagProcessor{
	...
	private static final String NOMEATRIBUTO = "classforerror";
	private static final int PRECEDENCIA = 1000;
	
	public ClassForErrorAttributeTagProcessor(String dialectPrefix) {
		super(TemplateMode.HTML, dialectPrefix, null, false, NOMEATRIBUTO, true, PRECEDENCIA, true);
	}
