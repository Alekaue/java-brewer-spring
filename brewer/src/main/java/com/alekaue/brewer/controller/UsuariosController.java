...
import com.alekaue.brewer.repository.Grupos;
import com.alekaue.brewer.repository.Usuarios;
import com.alekaue.brewer.repository.filter.UsuarioFilter;
import com.alekaue.brewer.service.CadastroUsuarioService;
import com.alekaue.brewer.service.StatusUsuario;
...
public class UsuariosController {
	...
	public ModelAndView pesquisar(UsuarioFilter usuarioFilter, 
							@PageableDefault(size=2) Pageable pageeable, HttpServletRequest httpServletRequest) {
		ModelAndView mv = new ModelAndView("/usuario/PesquisaUsuarios");
		mv.addObject("grupos", grupos.findAll());
		
		PageWrapper<Usuario> paginaWrapper = new PageWrapper<>(usuarios.filtrar(usuarioFilter, pageeable),
				httpServletRequest);
	...
	public void atualizarStatus(@RequestParam("codigo[]") Long[] codigos, @RequestParam("status") StatusUsuario status){
