package com.alekaue.brewer.model;
...
import com.alekaue.brewer.repository.listener.CervejaEntityListener;
import com.alekaue.brewer.validation.SKU;
...
public class Cerveja {
	...
	@DecimalMax(value = "100.0", message = "A comissão deve igual ou menor 100")
	private BigDecimal comissao;

	@NotNull(message = "A quantidade em estoque é obrigatória")
	@Max(value = 9999, message = "A quantidade em estoque deve ser menor q 9.999")
