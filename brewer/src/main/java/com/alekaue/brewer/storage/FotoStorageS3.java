...
public class FotoStorageS3 implements FotoStorage{
	...
	private static final String BUCKET = "alekauebrewer";
	...
	public String salvar(MultipartFile[] files) {
		...
		if (files != null && files.length > 0){
			...
			try {
				...
				enviarThambnail(novoNome, arquivo, acl);
	...
	public String getUrl(String foto) {
		if(!StringUtils.isEmpty(foto)){
			return "https://s3-sa-east-1.amazonaws.com/alekauebrewer/" + foto;
		}
		return null;
	}
	...
	private void enviarThambnail(String novoNome, MultipartFile arquivo, AccessControlList acl) throws IOException {
